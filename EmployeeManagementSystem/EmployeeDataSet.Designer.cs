...
namespace EmployeeManagementSystem {
    ...
    public partial class EmployeeDataSet : global::System.Data.DataSet {
        ...
        public partial class EmpDataTable : global::System.Data.TypedTableBase<EmpRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public EmpRow AddEmpRow(int Empno, string Ename, decimal Salary, System.DateTime HireDate) {
        ...
        public partial class EmpRow : global::System.Data.DataRow {
            ...
            public decimal Salary {
                get {
                    try {
                        return ((decimal)(this[this.tableEmp.SalaryColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
...
namespace EmployeeManagementSystem.EmployeeDataSetTableAdapters {
    ...
    public partial class EmpTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Emp] WHERE (([Empno] = @Original_Empno) AND ((@IsNull_Ename = 1 AND [Ename] IS NULL) OR ([Ename] = @Original_Ename)) AND ((@IsNull_Salary = 1 AND [Salary] IS NULL) OR ([Salary] = @Original_Salary)) AND ((@IsNull_HireDate = 1 AND [HireDate] IS NULL) OR ([HireDate] = @Original_HireDate)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Emp] ([Empno], [Ename], [Salary], [HireDate]) VALUES (@Empno, " +
                "@Ename, @Salary, @HireDate);\r\nSELECT Empno, Ename, Salary, HireDate FROM Emp WHE" +
                "RE (Empno = @Empno)";
...
SELECT Empno, Ename, Salary, HireDate FROM Emp WHERE (Empno = @Empno)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Empno, Ename, Salary, HireDate FROM dbo.Emp";
